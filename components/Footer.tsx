    ...
    return (
        <footer className="bg-foreground text-background py-16">
            <div className="max-w-7xl mx-auto px-6">
                <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
                    ...
                    <div className="sm:col-span-2 lg:col-span-1">
                        ...
                        <p className="text-background/60 text-sm leading-relaxed mb-6">
                            L'application de fitness propulsée par l'IA.
                        </p>
                        <a
                            href="https://apps.apple.com"
                            className="inline-flex items-center gap-2 px-5 py-3 bg-background text-foreground rounded-full text-sm font-bold hover:opacity-90 transition-opacity"
                        >
                    ...
                    {/* Navigation */}
                    <div>
                        <h4 className="font-bold text-sm uppercase tracking-wider text-background/40 mb-4">
                            Navigation
                        </h4>
                    ...
                    <div>
                        ...
                        <ul className="space-y-3 text-sm">
                            <li>
                                <a href="mailto:hello@shapefitness.app" className="text-background/70 hover:text-background transition-colors flex items-center gap-2">
                                    <Mail className="w-4 h-4" />
                                    hello@shapefitness.app
                                </a>
                            </li>
                        </ul>
                    </div>
                ...
                {/* Bottom */}
                <div className="pt-8 border-t border-background/10 flex flex-col sm:flex-row justify-between items-center gap-4 text-sm text-background/40">
                    <p>© {new Date().getFullYear()} SHAPE. Tous droits réservés.</p>
