...
export function Features({ dict }: FeaturesProps) {
    ...
    const icons = [Dumbbell, Utensils, Brain, Pencil];
    const images = [
        "/assets/app-screens/workout-detail-dark.png",
        "/assets/app-screens/food-detail-dark.png",
        "/assets/app-screens/home-light.png",
        "/assets/app-screens/library-dark.png"
    ];
            ...
            <div ref={ref} className="max-w-6xl mx-auto">
                ...
                >
                    ...
                    <h2 className="text-4xl sm:text-5xl lg:text-6xl font-black tracking-tight">
                        {dict.header.title.prefix}
                        <br />
                        <span className="text-gradient">{dict.header.title.gradient}</span>
                    </h2>
                </motion.div>
